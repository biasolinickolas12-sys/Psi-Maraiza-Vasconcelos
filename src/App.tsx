            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <span className="text-[10px] md:text-xs font-black text-slate-900/60 uppercase tracking-[0.3em] mb-3 md:mb-4">Psicóloga Clínica e Social</span>
                  <p className="text-lg md:text-2xl text-slate-900 font-serif font-black italic leading-relaxed text-center tracking-tight drop-shadow-sm px-2">
