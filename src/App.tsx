    ...
    <div className="fixed inset-0 bg-slate-100 z-[100] flex flex-col h-screen overflow-hidden">
      <div className="bg-white border-b border-slate-200 p-4 flex justify-between items-center shrink-0 shadow-sm z-10">
        ...
        <div className="flex items-center gap-4">
          <button onClick={() => setIsModalOpen(true)} className="bg-slate-900 text-white px-6 py-2 rounded-full font-bold flex items-center gap-2 hover:bg-slate-800 shadow-md">
            <Plus size={20} />
            Novo Paciente
          </button>
          <button onClick={onClose} className="p-2 hover:bg-slate-100 rounded-full text-slate-500">
            ...
            <div key={p.id} className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col gap-4 relative overflow-hidden group">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div className="bg-slate-50 p-2 rounded-xl">
                  ...
                  <span className="font-medium text-slate-700">{p.data_consulta ? new Date(p.data_consulta).toLocaleDateString('pt-BR') : '-'}</span>
                </div>
                <div className="bg-slate-50 p-2 rounded-xl">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/60 z-[110] flex items-center justify-center p-4 backdrop-blur-sm overflow-y-auto">
          <div className="bg-white rounded-3xl p-8 max-w-2xl w-full my-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-black text-slate-900">Adicionar Novo Paciente</h2>
